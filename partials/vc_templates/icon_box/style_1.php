...
<?php if( $style == 'icon_left' ) { ?>
    ...
    <?php if( $icon ) { ?>
        <div class="icon <?php echo esc_attr( $icon_class ); ?>" <?php echo sanitize_text_field( $icon_style ); ?>>
            <?php if(is_array($icon)):?>
                <i class="icon-image" style="background-image:url(<?php echo $icon['url']?>)"></i>
            <?php else:?>
    ...
    <div class="icon_text">
        <?php if( $title ) { ?>
            <h2 <?php echo sanitize_text_field( $title_style ); ?> <?php echo sanitize_text_field( $title_class ); ?>><?php echo wp_kses( $title, array( 'br' => array(),'sup' => array() ) ); ?></h2>
        <?php } ?>
...
<?php } elseif( $style == 'icon_left_transparent' ) { ?>
    ...
    <?php } ?>
    <?php if( $title ) { ?>
        <h5 <?php echo sanitize_text_field( $title_style ); ?> <?php echo sanitize_text_field( $title_class ); ?>><?php echo wp_kses( $title, array( 'br' => array(),'sup' => array() ) ); ?></h5>
    <?php } ?>
    <div class="icon_text">
        <?php echo consulting_filtered_output( $content ); ?>
    </div>
...
<?php } else { ?>
    ...
    <div class="icon_text">
        ...
        <?php endif; ?>
        <?php if( $title ) { ?>
            <h4 <?php echo sanitize_text_field( $title_style ); ?> <?php echo sanitize_text_field( $title_class ); ?>><?php echo wp_kses( $title, array( 'br' => array(),'sup' => array() ) ); ?></h4>
        <?php } ?>
        <?php echo consulting_filtered_output( $content ); ?>
    </div>
    <?php if( !empty( $link[ 'url' ] ) ): ?>
